...
def isencaogerados1(contador, cont, bot: DesktopBot, self: DesktopBot, executation=None):
   global execucao_permitida
                        ...
                        for im in img:
                           try:
                              if not bot.find(im, matching=0.85, waiting_time=1000):
                                    ...
                                    bot.click()
                                    imgreq = ["requerimento", "requerimento2", "requerimento3"]
                                    for img in imgreq:
                                       try:
                                    ...
                                    bot.type_keys(["ctrl", "tab"])     
                                    isencaogerados1(contador, cont, bot=self, self=self)
