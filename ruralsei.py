...
def ruralsei(contador, cont, bot: DesktopBot, self: DesktopBot, executation=None):
   ...
   while (contador < cont):
                     ...
                     try:
                        ...
                        #bot.type_down()
                        #bot.type_keys(["ctrl", "tab"])
                        #etapas(contador, cont, bot=self, self=self)
                     ...
                     #bot.mouse_down()
                     #bot.move_random(range_x=0, range_y=89)
                     #pyautogui.drag(100,100,5)
                     #bot.drag
